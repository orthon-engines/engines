...
Usage:
    from orthon._internal.engines.characterize import Characterizer
...
try:
    from orthon._internal.engines.break_detector import compute_breaks, analyze_break_pattern, get_break_metrics
    HAS_BREAK_DETECTOR = True
except ImportError:
    HAS_BREAK_DETECTOR = False

try:
    from orthon._internal.engines.heaviside import get_heaviside_metrics
    HAS_HEAVISIDE = True
except ImportError:
    HAS_HEAVISIDE = False

try:
    from orthon._internal.engines.dirac import get_dirac_metrics
    HAS_DIRAC = True
except ImportError:
    HAS_DIRAC = False
...
def compute_dfa_with_derivation(
    ...
    """
    from orthon._internal.entry_points.derivations.base import Derivation
...
from orthon._internal.engines.engine_mapping import (
    ENGINE_MAPPING,
