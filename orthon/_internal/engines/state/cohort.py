...
from orthon._internal.db.polars_io import upsert_parquet, write_parquet_atomic
from orthon._internal.utils.domain import require_domain
...
def run_cohort_state(
    ...
    if classify and len(transitions_df) >= 5:
        ...
        try:
            from orthon._internal.state import StateClassifier, extract_all_signatures
            ...
            signatures = []
            for window in transition_windows:
                from orthon._internal.state import extract_signature
                try:
