...
SIGNALS = VECTOR
from orthon._internal.db.polars_io import read_parquet, upsert_parquet, write_parquet_atomic
from orthon._internal.utils.memory import (
    force_gc,
    get_memory_usage_mb,
    get_size_mb,
    MemoryTracker,
...
from orthon._internal.utils.stride import load_stride_config, get_default_tiers

# Normalization configuration
import yaml

# Inline modules (characterize + laplace)
from orthon._internal.engines.characterize import (
    characterize_signal,
    get_engines_from_characterization,
    get_characterization_summary,
)
from orthon._internal.engines.laplace.transform import (
...
from orthon._internal.engines.pointwise import (
    HilbertEngine,
    DerivativesEngine,
    StatisticalEngine,
)
from orthon._internal.core.signals.types import DenseSignal, SparseSignal
...
from orthon._internal.core.domain_clock import DomainClock, DomainInfo
from orthon._internal.config.loader import load_clock_config, load_delta_thresholds
...
from orthon._internal.engines import VECTOR_ENGINES, OBSERVATION_ENGINES, compute_breaks
            ...
            for values, timestamp, lookback_start, actual_obs in windows:
                ...
                if actual_obs >= min_obs_break:
                    try:
                        ...
                        from orthon._internal.engines import get_break_metrics, get_heaviside_metrics, get_dirac_metrics
...
def process_signal_sequential(
    ...
    from orthon._internal.engines.vector_score import (
        ENGINE_CONFIGS,
        compute_baselines,
...
def run_window_tier(
    ...
    from orthon._internal.db.progress_tracker import ProgressTracker
