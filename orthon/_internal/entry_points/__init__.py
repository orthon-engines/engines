...
ENTRY_POINT_REGISTRY: Dict[str, Dict[str, Any]] = {
    ...
    'characterize': {
        ...
        'note': 'Module, not CLI entry point. Use from orthon._internal.engines.characterize import characterize_signal',
    },
...
# =============================================================================
try:
    from orthon._internal.entry_points.signal_vector import (
        UnivariateVector,
        UnivariateResult,
        compute_univariate,
        process_signal,
...
try:
    from orthon._internal.entry_points.geometry import (
        load_cohort_members,
    )
except ImportError:
    pass
...
try:
    from orthon._internal.engines.laplace.transform import compute_laplace_field
except ImportError:
    pass
