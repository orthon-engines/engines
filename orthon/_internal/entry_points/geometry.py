...
from orthon._internal.utils.memory import force_gc, get_memory_usage_mb
from sklearn.cluster import KMeans
from sklearn.preprocessing import StandardScaler
from orthon._internal.db.scratch import TempParquet, merge_to_table
from orthon._internal.engines.utils.parallel import (
    WorkerAssignment,
    divide_by_count,
    generate_temp_path,
    run_workers,
...
from orthon._internal.utils.stride import (
    load_stride_config,
    get_window_dates,
...
from orthon._internal.config.windows import get_window_weight

# Adaptive domain clock integration
from orthon._internal.config.loader import load_delta_thresholds
import json

# Bisection analysis
from orthon._internal.utils import bisection
...
from orthon._internal.engines.geometry.modes import (
    discover_modes,
    compute_affinity_weighted_features,
)
from orthon._internal.engines.spectral.wavelet import (
    run_wavelet_microscope,
    extract_wavelet_features,
)

# V2 Architecture: Geometry from Laplace fields
from orthon._internal.engines.geometry.snapshot import (
    compute_geometry_at_t,
    compute_geometry_trajectory,
    snapshot_to_vector,
    get_unified_timestamps,
)
from orthon._internal.engines.geometry.coupling import compute_coupling_matrix, compute_affinity_matrix
from orthon._internal.engines.geometry.divergence import compute_divergence, compute_divergence_trajectory
from orthon._internal.engines.geometry.modes import discover_modes as discover_modes_v2
from orthon._internal.core.signals.types import LaplaceField, GeometrySnapshot
from orthon._internal.engines.laplace.transform import compute_laplace_field as compute_laplace_field_v2
...
def make_cohort_row(
    ...
    row.update({
        ...
        # Mode discovery metrics (from orthon._internal.engines.modes)
        ...
        # Wavelet degradation metrics (from orthon._internal.engines.wavelet_microscope)
