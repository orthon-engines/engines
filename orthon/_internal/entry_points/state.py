...
SIGNALS = VECTOR
from orthon._internal.db.polars_io import read_parquet, upsert_parquet
from orthon._internal.db.scratch import TempParquet, merge_temp_results
...
from orthon._internal.engines.state.energy_dynamics import EnergyDynamicsEngine
from orthon._internal.engines.state.tension_dynamics import TensionDynamicsEngine
from orthon._internal.engines.state.phase_detector import PhaseDetectorEngine
from orthon._internal.engines.cohort_aggregator import CohortAggregatorEngine
from orthon._internal.engines.state.transfer_detector import TransferDetectorEngine

# V2 Architecture: State trajectory from geometry snapshots
from orthon._internal.engines.state.trajectory import (
...
from orthon._internal.core.signals.types import GeometrySnapshot, StateTrajectory, LaplaceField
